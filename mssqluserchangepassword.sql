...
<p>Если вы счастливый обладатель техники от фирмы Apple, то используйте сочетание <b>FN+CTRL+ALT+DELETE</b>.<br>
Введите текущий пароль и 2 раза новый.</p>
...
Пароль не должен совпадать с одним из 24-х ранее использованных.</p>
</body>
</html>';
